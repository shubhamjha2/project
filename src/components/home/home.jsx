...
export default function Home() {
  ...
  return (
    <div className="home_root">
      <div className={`home_bg1 ${currentSlide === 0 ? "visible" : "hidden"}`}>
        <img
        ...
        <img
          ...
          src={process.env.PUBLIC_URL + "/images/home_img/pngegg-2-min (1).png"}
          alt="Overlay"
        />
        <img
      ...
      <div className={`home_bg2 ${currentSlide === 1 ? "visible" : "hidden"}`}>
        <img
        ...
        <img
          ...
          src={
            process.env.PUBLIC_URL + "/images/home_img/slide_img/pngegg (5).png"
          }
          alt="Overlayslide14"
        />
